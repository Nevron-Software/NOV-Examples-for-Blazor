...
{
	/// <summary>
	/// Stacked Area 3D Example
	/// </summary>
	public class NStackedArea3DExample : NExampleBase
	{
		#region Constructors
		...
		/// Static constructor
		/// </summary>
		static NStackedArea3DExample()
		{
			NStackedArea3DExampleSchema = NSchema.Create(typeof(NStackedArea3DExample), NExampleBaseSchema);
		}
		...
		protected override NWidget CreateExampleContent()
		{
			...
			// configure title
			m_ChartView.Surface.Titles[0].Text = "Stacked Area 3D";

			// configure chart
			NCartesianChart chart = (NCartesianChart)m_ChartView.Surface.Charts[0];

			chart.Enable3D = true;
            chart.ModelWidth = 100;
            chart.ModelDepth = 20;
		...
		{
			return @"<p>This example demonstrates how to create a 3D stacked area chart.</p>";
		}
		...
		public static readonly NSchema NStackedArea3DExampleSchema;
