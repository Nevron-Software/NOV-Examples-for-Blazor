...
namespace Nevron.Nov.Examples.Chart
{
	...
	/// Cluster Bar Example
	/// </summary>
	public class NXYZScatterStackBarExample : NExampleBase
	{
		#region Constructors
		...
		/// Default constructor
		/// </summary>
		public NXYZScatterStackBarExample()
		{
		...
		/// Static constructor
		/// </summary>
		static NXYZScatterStackBarExample()
		{
			NXYZScatterStackBarExampleSchema = NSchema.Create(typeof(NXYZScatterStackBarExample), NExampleBaseSchema);
		}
		...
		public static readonly NSchema NXYZScatterStackBarExampleSchema;
